...
from src.backend.core.ai_translator.config_manager import api_config_manager
from src.backend.core.ai_translator.agents.agent_manager import agent_definition_manager
from src.backend.core.ai_translator.data_models import APIConfig, ImageTranslationResult
