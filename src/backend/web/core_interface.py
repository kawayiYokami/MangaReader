...
# 导入core模块
from src.backend.core.manga.manga_manager import MangaManager
from src.backend.core.manga.manga_model import MangaInfo
from src.backend.core.manga.data_source import DataSourceFactory
...
from src.backend.core.image import processor
from src.backend.core.utils.file_system import safe_replace_file
    ...
    async def start_random_session(self, limit: int = 50) -> Tuple[Optional[str], List[WebMangaInfo]]:
        ...
        try:
            ...
            with self._random_session_lock:
                ...
                if len(self._random_sessions) % 10 == 0:
                    self._cleanup_random_sessions()
