...
import asyncio
from src.backend.core.core_cache.cache_interface import CacheInterface
from src.backend.core.core_cache.manga_cache import MangaListCacheManager
from src.backend.core.core_cache.ocr_cache_manager import OcrCacheManager
from src.backend.core.core_cache.page_policy_cache import PagePolicyCacheManager
from src.backend.core.core_cache.thumbnail_cache import ThumbnailCache
from src.backend.core.core_cache.page_cache import get_page_cache
from src.backend.core.core_cache.translation_cache import TranslationCacheManager
...
async def broadcast_cache_event(event_type: str, cache_type: str, data: Dict[str, Any] = None):
    ...
    try:
        # 动态导入以避免循环导入
        from src.backend.web.websocket.handlers import manager
...
# 使用时: from src.backend.core.core_cache.cache_factory import cache_factory
