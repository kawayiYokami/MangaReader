...
from src.backend.core.core_cache.page_cache import PageCache
from src.backend.core.core_cache.thumbnail_cache import ThumbnailCache # 引入ThumbnailCache
from src.backend.core.core_cache.cache_key_generator import CacheKeyGenerator
from src.backend.core.image import processor
from src.backend.core.manga.policy_constants import POLICY_PENDING
