...
from qfluentwidgets import (NavigationInterface, NavigationItemPosition, 
                           ...
                           setTheme, Theme, SplitFluentWindow, isDarkTheme)
...
class MainWindow(SplitFluentWindow):
    def __init__(self):
        ...
        self.addSubInterface(self.manga_browser_interface, FIF.LIBRARY, '漫画', isTransparent=True)
        
        # 添加设置页面
        self.settings_interface = SettingsInterface(self)
        self.settings_interface.setObjectName("settingsInterface")
        self.addSubInterface(self.settings_interface, icon = FIF.SETTING, text='设置', position=NavigationItemPosition.BOTTOM, isTransparent=True)
